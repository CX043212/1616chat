/**
 * screenShot_main.js Created by xh on 2018-5-11
 */
...
module.exports = function(winContent, obj) {
    ...
    // 监听更新截图快捷键
    ipcMain.on('update-shortCut', function(e, oldAccelerator, accelerator){
        shortCutUpdate(oldAccelerator, accelerator)
    });
    
    function shortCutUpdate(oldAccelerator, accelerator){
        // 先清除
        oldAccelerator && globalShortcut.unregister(oldAccelerator);
        accelerator && globalShortcut.register(accelerator, function() {
