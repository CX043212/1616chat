const getters = {
    avalute:state=>state.card.avalute,
    ...
    getUsername:state=>state.card.username,
    ...
    getIsUpdate:(state)=>state.card.isUpdate,
    getIsExit:(state)=>state.card.isExit,
    getFriendNum:state=>state.friendList.num
  };
