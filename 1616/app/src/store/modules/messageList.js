...
const messageList = {
    ...
    mutations: {
      ...
      APPEND_MSG: (state, msgobj) =>{
        console.log( msgobj,"发送的信息mutation")
        console.log( msgobj.selToID,"发送给谁")
        console.log(state.selToID)
        console.log(msgobj.msgList[0],"追加的信息")
        msgobj.selToID==state.selToID? state.currentMsg.push(msgobj.msgList[0]):""
        state.msgtrigger++;
      },
      //选择新的好友进行聊天
